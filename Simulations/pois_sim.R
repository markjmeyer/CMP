...
# priors_c2     <- list(a = 2, b = log(2), c = 2) # add two subjects, one with x_i = 2, x_i = 0
...
##### bias #####
xtable(t(matrix(apply(lamMat - lambda, c(2,3), median), nrow = 6, byrow = FALSE,
       dimnames = list(Models = modNames, `Sample Sizes` = n))), digits = 3)
xtable(t(matrix(apply(nuMat - nu, c(2,3), median), nrow = 6, byrow = FALSE,
       dimnames = list(Models = modNames, `Sample Sizes` = n))), digits = 3)

##### MSE #####
xtable(t(matrix(apply((lamMat - lambda)^2, c(2,3), median), nrow = 6, byrow = FALSE,
       dimnames = list(Models = modNames, `Sample Sizes` = n))), digits = 3)
xtable(t(matrix(apply((nuMat - nu)^2, c(2,3), median), nrow = 6, byrow = FALSE,
       dimnames = list(Models = modNames, `Sample Sizes` = n))), digits = 3)
...
##### coverage #####
xtable(t(matrix(apply(cov_lam, c(2,3), mean), nrow = 6, byrow = FALSE,
       dimnames = list(Models = modNames, `Sample Sizes` = n))))
xtable(t(matrix(apply(cov_nu, c(2,3), mean), nrow = 6, byrow = FALSE,
       dimnames = list(Models = modNames, `Sample Sizes` = n))))
